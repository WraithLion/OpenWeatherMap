...
#Funcion que realiza la peticion y envía un mensaje si existe una advertencia o error, en caso contrario sigue
revisar <- tryCatch({
...
#Descripcion del clima si es nuboso, soleado, lluvioso...
TablaClima$Descripcion[i] <- Clima_filtro$y[1]
#Temperatura minima del lugar
...
#Guarda la informacion capturada en un archivo csv.
